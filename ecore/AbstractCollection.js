...
var ArrayList_1 = require("ecore/ArrayList");
    ...
    */
    function AbstractCollection(owner, featureId, oppositeFeatureId) {
        ...
        _this.createNotification = function (eventType, oldValue, newValue, index, wasSet) {
            return new ENotificationImpl_1.ENotificationImpl(_this.owner, eventType, _this.featureId, oldValue, newValue);
        };
        ...
        _this.addAll = function (collection) {
            for (var _i = 0, collection_1 = collection; _i < collection_1.length; _i++) {
                ...
                _this.push(item); //TODO push or add?
            }
            return true; //TODO
        };
        ...
        _this.remove_ = function (element) {
            if (_this.isNotificationRequired()) {
                ...
                var index = 1000;
                var notification = _this.createNotification(NotificationImpl_1.NotificationImpl.REMOVE, oldObject, null, index, oldIsSet);
        ...
        _this.basicAdd = function (element, notifications) {
            if (_this.isNotificationRequired()) {
                ...
                _this.push(element);
                var notification = _this.createNotification(NotificationImpl_1.NotificationImpl.ADD, null, element, index, oldIsSet);
                if (notifications == null) {
