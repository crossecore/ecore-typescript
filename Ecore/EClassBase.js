    ...
    Object.defineProperty(EClassBase.prototype, "eStructuralFeatures", {
        get: function () {
            if (this._eStructuralFeatures === null) {
                this._eStructuralFeatures = new OrderedSet(this, EcorePackageLiterals.ECLASS_ESTRUCTURALFEATURES, EcorePackageLiterals.ESTRUCTURALFEATURE_ECONTAININGCLASS);
            }
    ...
    Object.defineProperty(EClassBase.prototype, "eOperations", {
        get: function () {
            if (this._eOperations === null) {
                this._eOperations = new OrderedSet(this, EcorePackageLiterals.ECLASS_EOPERATIONS, EcorePackageLiterals.EOPERATION_ECONTAININGCLASS);
            }
    ...
    Object.defineProperty(EClassBase.prototype, "eGenericSuperTypes", {
        get: function () {
            if (this._eGenericSuperTypes === null) {
                this._eGenericSuperTypes = new OrderedSet(this, EcorePackageLiterals.ECLASS_EGENERICSUPERTYPES, BasicEObjectImpl.EOPPOSITE_FEATURE_BASE - EcorePackageLiterals.ECLASS_EGENERICSUPERTYPES);
            }
    ...
    Object.defineProperty(EClassBase.prototype, "eSuperTypes", {
        get: function () {
            if (this._eSuperTypes === null) {
                this._eSuperTypes = new OrderedSet(this, EcorePackageLiterals.ECLASS_ESUPERTYPES, BasicEObjectImpl.EOPPOSITE_FEATURE_BASE - EcorePackageLiterals.ECLASS_ESUPERTYPES);
            }
