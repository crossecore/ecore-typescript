...
define(["require", "exports", "ecore/ArrayList", "ecore/NotificationImpl"], function (require, exports, ArrayList_1, NotificationImpl_1) {
    "use strict";
        ...
        function AbstractCollection(owner, featureId, oppositeFeatureId) {
            ...
            _this.remove_ = function (element) {
                if (_this.isNotificationRequired()) {
                    ...
                    var notification = new NotificationImpl_1.NotificationImpl(NotificationImpl_1.NotificationImpl.REMOVE, oldObject, null, index, oldIsSet);
            ...
            _this.basicAdd = function (element, notifications) {
                if (_this.isNotificationRequired()) {
                    ...
                    var notification = new NotificationImpl_1.NotificationImpl(NotificationImpl_1.NotificationImpl.ADD, null, element, index, oldIsSet);
                    if (notifications == null) {
            ...
            */
             ...
             */
            _this.includes = function (element) {
